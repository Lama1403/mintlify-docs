---
title: "Staking"
description: "Overview of solo staking and delegated staking options in Zilliqa 2.0"
---
...
Node operators with sufficient funds to deposit the minimum stake required of validators can turn their node into a validator node as soon as it is synced, and join a staking pool later. Detailed instructions can be found [here](/node-operations/staking/delegated-staking).
...
Refer [here](/node-operations/staking/delegated-staking) for more information.