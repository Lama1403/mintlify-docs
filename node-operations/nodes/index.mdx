...
description: "Comprehensive guide to Zilliqa nodes and the process of becoming a validator in the Zilliqa Proof of Stake network"
---
...
For more details, please refer to the [Networks section](/getting-started/endpoints#networks).