...
description: "Learn how pruning and passive sync mechanisms work in Zilliqa 2.0 nodes"
---
...
<Warning>
Only one of these values can be set at a time. Setting both is invalid.
